------------------------------------ Задание №1
create or replace procedure C##PVG_P.GET_TEACHERS(PCODE TEACHER.PULPIT%TYPE)
    is
...
------------------------------------ Задание №2
create or replace function C##PVG_P.GET_NUM_TEACHERS (PCODE TEACHER.PULPIT%TYPE)
return number
is
    result_num number;
begin
...
------------------------------------ Задание №3
create or replace procedure C##PVG_P.GET_TEACHERS_BY_FACULTY (FCODE FACULTY.FACULTY%TYPE)
    is
...
create or replace procedure C##PVG_P.GET_SUBJECTS (PCODE SUBJECT.PULPIT%TYPE)
is
...
------------------------------------ Задание №4
create or replace function C##PVG_P.FGET_NUM_TEACHERS (FCODE FACULTY.FACULTY%TYPE)
return number
is
    result_num number;
begin
...
create or replace function C##PVG_P.GET_NUM_SUBJECTS (PCODE SUBJECT.PULPIT%TYPE) return number
is
    result_num number;
begin
